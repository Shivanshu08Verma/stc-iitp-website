      ...
      <div className="container mx-auto px-4 flex justify-end items-center mt-1 mb-6 relative z-40">
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            <div
              className={`absolute right-0 mt-3 w-full bg-[#0F172A]/95 backdrop-blur-2xl border border-white/10 rounded-2xl overflow-hidden transition-all duration-300 origin-top shadow-2xl ${isOpen ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"
                }`}
            >
              {years.map((year) => (
                <button
                  ...
                  className={`w-full px-6 py-4 text-left text-xs sm:text-sm font-bold uppercase tracking-widest transition-all duration-300 border-b border-white/5 last:border-0 cursor-pointer ${selectedYear === year
