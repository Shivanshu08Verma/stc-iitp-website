export default function HeroAbout() {
	return (
		<section className="mt-10 mb-15 flex flex-col items-center w-full">
			<h1
				className="text-center text-[80px] md:text-[130px] font-extrabold mb-25 tracking-[0.05em] leading-none opacity-0 animate-title-reveal"
				style={{ animationDelay: "80ms" }}
			>
				<span className="text-transparent bg-clip-text bg-linear-to-br from-[#ffffff] via-[#e2e8f0] to-[#3b82f6]">
					ICTC
				</span>
			</h1>
			...
			>
				<h2 className="text-[28px] md:text-[32px] font-bold mb-6 text-white tracking-wide">
					About
				</h2>
				<p className="text-[#94a3b8] text-[16px] md:text-[18px] leading-[1.8] md:leading-loose text-justify font-light">
