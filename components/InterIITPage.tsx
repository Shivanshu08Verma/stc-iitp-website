...
export default function InterIITPage() {
  ...
  return (
    ...
    >
      <section className="relative w-full min-h-[480px] md:min-h-[520px] flex flex-col lg:flex-row items-stretch overflow-hidden border-b border-white/5">
        <div
          className="relative z-10 flex flex-col justify-center px-6 sm:px-10 md:px-16 py-14 md:py-16 w-full lg:w-[62%]"
          style={{
            backgroundImage: `
        ...
        >
          <p className="font-mono text-[10px] tracking-[0.25em] text-[#21ED58]/80 mb-5 flex items-center gap-2">
            <span className="inline-block w-6 h-px bg-[#21ED58]/60" />
            LEGACY DATABASE: IITP
          </p>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight uppercase mb-5">
            INTER IIT
            <br />
            TECH MEET
          </h1>

          <div className="flex items-stretch gap-0 mb-7 w-max">
        ...
        <div className="relative w-full lg:w-[38%] flex flex-col items-center justify-center py-12 lg:py-0 bg-[#020611]">
          <div className="absolute top-0 left-0 w-[90%] h-[10px] bg-[#21ED58]/15 z-20" />
          <div className="hidden lg:block absolute top-[10px] left-0 w-[8px] h-[calc(100%-10px)] bg-[#21ED58]/15 z-20" />
          ...
          <div className="lg:absolute bottom-6 right-8 mt-8 lg:mt-0 font-mono text-[9px] text-center lg:text-right leading-5 z-10">
      ...
      <section className="w-full px-6 sm:px-10 lg:pl-[200px] lg:pr-[180px] py-16 lg:py-[128px] border-b border-[#5EAF73]/20 flex justify-center scroll-mt-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-[150px] w-full max-w-[1600px]">
          ...
          <div className="flex-shrink-0 w-full max-w-[280px] sm:max-w-[350px] lg:max-w-[428px] aspect-square relative">
            <Image
          ...
          <table className="w-full text-left border-collapse min-w-[480px]">
            <thead>
              <tr className="border-b border-white/10">
                {["REF ID", "PROBLEM STATEMENT", "CATEGORY", "RANK"].map(
                  (h) => (
                    <th
                      key={h}
            ...
            <tbody>
              {performances.map((p) => (
                ...
                >
                  <td className="py-5 pr-4 md:pr-6 font-mono text-[11px] text-[#94A3B8] whitespace-nowrap">
                    {p.id}
                  </td>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
          ...
          <div className="row-span-1 lg:row-span-2 aspect-[4/3] lg:aspect-auto overflow-hidden relative bg-[#090f1a]">
            <ArchiveImage
              src={visualArchiveImages[2] || "/archive-3.jpg"}
              alt="Archive Image 3"
            />
            <div className="absolute inset-0 bg-black/20 hover:bg-transparent transition-colors duration-300" />
            <div className="absolute inset-0 border border-transparent hover:border-[#21ED58]/20 transition-colors duration-300 pointer-events-none" />
          ...
          <div className="aspect-[4/3] bg-[#00072D] border border-[#21ED58]/20 overflow-hidden relative flex flex-col items-center justify-center gap-3">
            <svg
