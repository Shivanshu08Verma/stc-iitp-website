...
export default function Footer() {
	...
	return (
		<footer
			className={`w-full bg-[linear-gradient(180deg,#020617_0%,#0F172A_100%)] border-t border-gray-800 text-[#94A3B8] pt-12 lg:pt-16 pb-4 ${josefin.className}`}
		>
					...
					<div className="col-span-1">
						<div className="flex items-start gap-4 mb-10">
							<svg
								...
								strokeWidth={1.5}
								stroke="currentColor"
								className="shrink-0 text-[#6BFB9A]"
							>
								<path
									strokeLinecap="round"
