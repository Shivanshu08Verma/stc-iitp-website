...
const allEvents: Record<number, Event[]> = {
  2025: [
    ...
    {
      name: "Quant Circuit Challenge",
      club: "QTC",
      dates: "1st July – 21st July",
    },
    {
      name: "Avogadro's Playground",
      club: "ChESSx",
      dates: "2nd July – 4th July",
    },
    { name: "Cross & Beyond", club: "ACE", dates: "6th July – 9th July" },
    {
      name: "Brandstorm",
      club: "E-Cell & MoodBoard",
      dates: "1st July – 8th July",
    },
  ],
  2026: [],
};
